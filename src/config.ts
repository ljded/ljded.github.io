...
export const siteConfig: SiteConfig = {
	...
	bangumi: {
		userId: "ljded", // 在此处设置你的Bangumi用户ID，可以设置为 "sai" 测试
	...
	bilibili: {
		...
		useWebp: false, // 是否使用WebP格式（默认 true）
	},
	...
	links: [
		{
			name: "Bilibili",
			icon: "fa6-brands:bilibili",
			url: "https://space.bilibili.com/292538902",
		},
		{
			name: "Gitee",
			icon: "mdi:git",
			url: "https://gitee.com/ljded",
		},
		{
			name: "GitHub",
			icon: "fa6-brands:github",
			url: "https://github.com/ljded",
		},
		// {
		// 	name: "Codeberg",
...
export const umamiConfig = {
	...
	apiKey: import.meta.env.UMAMI_API_KEY || "api_Io1PEWFpR8VAyZk6skZZPEolspskVs81", // API密钥优先从环境变量读取，否则使用配置文件中的值
